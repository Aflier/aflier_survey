...
var _default = /*#__PURE__*/function (_Controller) {
  ...
  _createClass(_default, [{
    ...
    value: function submit(event) {
      ...
      var that = this; // Redraw all sections

      this.questionSectionTargets.forEach(function (element, index) {
        console.log("Questionnaire#submit - path: ".concat(element.dataset.path));
        _rails_ujs__WEBPACK_IMPORTED_MODULE_1___default.a.ajax({
          type: 'GET',
          url: element.name,
          dataType: 'json',
          success: function success(response) {
            that.submitBarTarget.innerHTML = response.html;
          },
          error: function error(response) {
            console.log('Setting could not be saved.');
          }
...
/******/ });
//# sourceMappingURL=application-6eefcd869d45d798a691.js.map